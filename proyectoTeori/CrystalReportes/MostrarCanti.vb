...
Public Class MostrarCanti
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "proyectoTeori.MostrarCanti.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Ndelito() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedMostrarCanti
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MostrarCanti = New MostrarCanti()
        rpt.Site = Me.Site
        Return rpt
    End Function
