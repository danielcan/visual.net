...
Public Class MostrarAbogado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "proyectoTeori.MostrarAbogado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_cod_Abogado() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Abo_Nombre() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedMostrarAbogado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MostrarAbogado = New MostrarAbogado()
        rpt.Site = Me.Site
        Return rpt
    End Function
