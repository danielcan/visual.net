...
Public Class MostrarExpediente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "proyectoTeori.MostrarExpediente.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Acu_codigo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedMostrarExpediente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MostrarExpediente = New MostrarExpediente()
        rpt.Site = Me.Site
        Return rpt
    End Function
